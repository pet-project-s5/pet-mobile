...
const STRINGS = {
  pt: {
    ...
    // PetEdit
    editPet: 'Editar Pet', newPet: 'Novo Pet',
    petNameLabel: 'Nome', speciesLabel: 'Espécie', breedLabel: 'Raça',
    selectBreed: 'Selecione a raça', ageYears: 'Idade (anos)',
    coatType: 'Tipo de Pelo', sizeLabel: 'Porte', sexLabel: 'Sexo',
    saveChanges: 'Salvar Alterações', registerPet: 'Cadastrar Pet',
    loadingPet: 'Carregando pet...',
    errPetName: 'Informe o nome do pet.', errSpecies: 'Selecione a espécie.',
    errBreed: 'Selecione a raça.', errCoat: 'Selecione o tipo de pelo.',
    errAge: 'Informe a idade (em anos).', errSize: 'Selecione o porte.',
    errSex: 'Selecione o sexo.',
    // PetProfile
    loadingPetProfile: 'Carregando perfil do pet...',
    sexInfoLabel: 'Sexo', ageInfoLabel: 'Idade', sizeInfoLabel: 'Porte', coatInfoLabel: 'Pelo',
    yearsUnit: 'anos', appointmentsSection: 'Agendamentos', scheduleBtn: 'Agendar',
    takePhoto: 'Tirar foto', chooseGallery: 'Escolher da galeria', removePhoto: 'Remover foto',
    // Register
    personalData: 'Dados Pessoais', addressStep: 'Endereço', accessData: 'Dados de Acesso',
    registerBtn: 'Cadastrar', alreadyHaveAccount: 'Já tenho uma conta',
    accountCreated: 'Conta criada!',
    welcomeTo: 'Bem-vindo(a) ao Cuddle,',
    accountCreatedHint: 'Seu cadastro foi concluído com sucesso. Agora você pode agendar serviços e cuidar do seu pet com amor.',
    enterApp: 'Entrar no app',
    fullName: 'Nome completo', confirmEmail: 'Confirmar E-mail',
    confirmPassword: 'Confirmar Senha',
    streetPlaceholder: 'Rua', numberPlaceholder: 'Número da residência',
    neighborhoodPlaceholder: 'Bairro', complementPlaceholder: 'Complemento (opcional)',
    // Schedule flow
  ...
  en: {
    ...
    // PetEdit
    editPet: 'Edit Pet', newPet: 'New Pet',
    petNameLabel: 'Name', speciesLabel: 'Species', breedLabel: 'Breed',
    selectBreed: 'Select breed', ageYears: 'Age (years)',
    coatType: 'Coat Type', sizeLabel: 'Size', sexLabel: 'Sex',
    saveChanges: 'Save Changes', registerPet: 'Register Pet',
    loadingPet: 'Loading pet...',
    errPetName: 'Enter the pet\'s name.', errSpecies: 'Select a species.',
    errBreed: 'Select a breed.', errCoat: 'Select coat type.',
    errAge: 'Enter age (in years).', errSize: 'Select size.',
    errSex: 'Select sex.',
    // PetProfile
    loadingPetProfile: 'Loading pet profile...',
    sexInfoLabel: 'Sex', ageInfoLabel: 'Age', sizeInfoLabel: 'Size', coatInfoLabel: 'Coat',
    yearsUnit: 'yrs', appointmentsSection: 'Appointments', scheduleBtn: 'Schedule',
    takePhoto: 'Take photo', chooseGallery: 'Choose from gallery', removePhoto: 'Remove photo',
    // Register
    personalData: 'Personal Info', addressStep: 'Address', accessData: 'Account',
    registerBtn: 'Register', alreadyHaveAccount: 'I already have an account',
    accountCreated: 'Account created!',
    welcomeTo: 'Welcome to Cuddle,',
    accountCreatedHint: 'Your registration is complete. You can now schedule services and care for your pet with love.',
    enterApp: 'Enter the app',
    fullName: 'Full name', confirmEmail: 'Confirm e-mail',
    confirmPassword: 'Confirm password',
    streetPlaceholder: 'Street', numberPlaceholder: 'House number',
    neighborhoodPlaceholder: 'Neighborhood', complementPlaceholder: 'Complement (optional)',
  ...
  es: {
    ...
    // PetEdit
    editPet: 'Editar Mascota', newPet: 'Nueva Mascota',
    petNameLabel: 'Nombre', speciesLabel: 'Especie', breedLabel: 'Raza',
    selectBreed: 'Selecciona la raza', ageYears: 'Edad (años)',
    coatType: 'Tipo de Pelaje', sizeLabel: 'Talla', sexLabel: 'Sexo',
    saveChanges: 'Guardar Cambios', registerPet: 'Registrar Mascota',
    loadingPet: 'Cargando mascota...',
    errPetName: 'Ingresa el nombre de la mascota.', errSpecies: 'Selecciona la especie.',
    errBreed: 'Selecciona la raza.', errCoat: 'Selecciona el tipo de pelaje.',
    errAge: 'Ingresa la edad (en años).', errSize: 'Selecciona la talla.',
    errSex: 'Selecciona el sexo.',
    // PetProfile
    loadingPetProfile: 'Cargando perfil de la mascota...',
    sexInfoLabel: 'Sexo', ageInfoLabel: 'Edad', sizeInfoLabel: 'Talla', coatInfoLabel: 'Pelaje',
    yearsUnit: 'años', appointmentsSection: 'Citas', scheduleBtn: 'Agendar',
    takePhoto: 'Tomar foto', chooseGallery: 'Elegir de galería', removePhoto: 'Quitar foto',
    // Register
    personalData: 'Datos Personales', addressStep: 'Dirección', accessData: 'Acceso',
    registerBtn: 'Registrarse', alreadyHaveAccount: 'Ya tengo una cuenta',
    accountCreated: '¡Cuenta creada!',
    welcomeTo: '¡Bienvenido(a) a Cuddle,',
    accountCreatedHint: 'Tu registro fue completado. Ya puedes agendar servicios y cuidar a tu mascota con amor.',
    enterApp: 'Entrar a la app',
    fullName: 'Nombre completo', confirmEmail: 'Confirmar correo',
    confirmPassword: 'Confirmar contraseña',
    streetPlaceholder: 'Calle', numberPlaceholder: 'Número de casa',
    neighborhoodPlaceholder: 'Colonia', complementPlaceholder: 'Complemento (opcional)',
